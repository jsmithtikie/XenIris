 ...
 * This file demonstrates how to integrate Xeniris with a web frontend
 */

// For React/Vue/Angular applications
export class XenirisClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new XenirisClient(provider, contractAddress);
